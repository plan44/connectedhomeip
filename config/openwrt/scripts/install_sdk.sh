...
# FIXME: we don't know yet what to do here yet
#   for now, we've done manually:
#      cd ${CHIPROOT}/thirdparty/openwrt
#      ln -s /Volumes/CaseSens/openwrt-2 repo
echo "OpenWrt rootstrap NOT YET IMPLEMENTED"
exit 1
